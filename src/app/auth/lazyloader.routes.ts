...
export const appRoutes: Routes = [
  {
    ...
    children: [
      { path: 'dashboard', component: DashboardCrmComponent },
      {
        ...
        loadChildren: () =>
          import('../material-widgets/material-widgets.module').then(
            (m) => m.MaterialWidgetsModule
          )
      },
      {
        path: 'tables',
      ...
      }, //fix this
      {
        path: 'guarded-routes',
        loadChildren: () =>
          import('../guarded-routes/guarded-routes.module').then(
            (m) => m.GuardedRoutesModule
          )
      },
      // { path: 'editor', loadChildren: () => import('../editor/editor.module').then(m => m.EditorModule) },
      {
        path: 'scrumboard',
        loadChildren: () =>
          import('../scrumboard/scrumboard.module').then(
      ...
      },
      {
        path: 'physio',
        loadChildren: () =>
          import('../physio/physio.module').then((m) => m.PhysioModule)
      }
    ]
  }
];
